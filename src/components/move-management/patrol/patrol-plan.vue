<template>
  <div class="patrol-plan">
    ...
    <div class="search">
      ...
      <Select clearable :label='searchVal.department_name' not-found-text='无匹配部门，请重新输入' v-model="searchVal.department_name" filterable
      ...
      <Select :label='searchVal.status' placeholder="请选择" v-model="searchVal.status" style="width:200px;padding-left: 10px;padding-right: 20px">
