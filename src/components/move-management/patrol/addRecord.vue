                    ...
                    <tr>
                        ...
                        <td class="ed-content">
                            <FormItem style="margin:0" prop="plan_name">
                                <Input disabled v-model="model.title" placeholder="请输入" style="width:95%"></Input>
                            </FormItem>
                        </td>
                        <td class="ed-label">执行部门</td>
                        <td class="ed-content">
                            <FormItem style="margin: 0" prop="plan_type">
                                <Select disabled :label='model.department_name' not-found-text='无匹配部门，请重新输入' v-model="model.department_name" filterable remote :remote-method="autoSearch"
                        ...
                        <td class="ed-content">
                            <FormItem style="margin:0" prop="plan_name">
                                <Input disabled v-model="model.department_level" placeholder="请输入" style="width:95%"></Input>
                            </FormItem>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ed-content">
                            <FormItem style="margin:0" prop="plan_name">
                                <Input disabled v-model="model.department_code" placeholder="请输入" style="width:95%"></Input>
                            </FormItem>
                        </td>
                        ...
                        <td class="ed-content">
                            <FormItem style="margin:0" prop="patrolman">
                                ...
                                <Input disabled v-model="model.patrolman" placeholder="请输入" style="width:95%"></Input>
                            </FormItem>
                        </td>
                        ...
                        <td class="ed-content">
                            <FormItem style="margin:0" prop="patrolman">
                                ...
                                <Input disabled v-model="model.telephone" placeholder="请输入" style="width:95%"></Input>
                            </FormItem>
                        </td>
                    </tr>
                    <tr style="height:80px">
                        ...
                        <td class="ed-content" colspan="5">
                            <FormItem style="margin:0" prop="description">
                                <Input disabled type="textarea" v-model="model.description" placeholder="请输入" style="width:95%"></Input>
                            </FormItem>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="ed-content" colspan="3">
                            <div class="upload">
                                <Upload :before-upload="handleUpload" action="http://192.168.1.138:8080/sanfangstruts/oa/sf_notice/upload?systemId=1000010">
                ...
                <div class="map">
                    <div class="amap-page-container">
                        ...
                        <el-amap vid="amapDemo" :center="mapCenter" :zoom="12" class="amap-demo">
                            <el-amap-marker :position="[model.lng,model.lat]"></el-amap-marker>
                        </el-amap>
                    </div>
                </div>
            </div>
...
import { addressBookApi, uploadApi } from 'api/daily-office'
...
export default {
  ...
  methods: {
    ...
    upload () {
      ...
      let form = new FormData() // eslint-disable-line
