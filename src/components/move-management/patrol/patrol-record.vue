    ...
    <div class="patrol-record">
        <div class="title">
            ...
            <Breadcrumb separator=">">
                ...
                <BreadcrumbItem>巡查上报数据</BreadcrumbItem>
            </Breadcrumb>
        </div>
        <div class="search">
            ...
            <span class="search_title">巡查地点</span>
            <Input v-model="searchVal.address" placeholder="请输入" style="width:200px;padding-left: 10px;padding-right: 20px"></Input>
...
export default {
  ...
  methods: {
    ...
    search () {
      ...
      if (this.postObj.searchValue.address) {
        this.postObj.searchValue.address = likeStrSearch(this.postObj.searchValue.address)
      }
      this.getList()
    },
    // 点击新增
    ...
    // 分页
    pageChange () {
      this.postObj.page = index // eslint-disable-line
      this.getList()
    },
    // 新增/修改保存
    save (obj) {
