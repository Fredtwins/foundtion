...
import { getLocalStorage, senActive, successNotice, errorNotice } from 'common/js/dom'
...
export default {
  ...
  created () {
    ...
    if (getLocalStorage('searchValue') && getLocalStorage('searchValue').plan_category === '专题预案') {
