<template>
  <div class="taskActive">
    <div class="general_content table">
      <preset-task :showTitle="false" :code="department_code" :planType="plan_type"></preset-task>
    </div>
    <!-- 详情 -->
...
import { getpresetTaskList, editpresetTask } from 'api/task_management'
import { getDepList } from 'api/bumenlist'
import presetTask from '../../taskManagement/preset_task.vue'
