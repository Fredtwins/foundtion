  ...
  <div class="affected-statical">
    ...
    <div class="title">
      ...
      <Breadcrumb separator=">">
        ...
        <BreadcrumbItem>受灾情况统计</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <!-- <div class="search">
...
import { affectedThead } from 'common/js/table'
import { affectedApi, affecteddetailsApi } from 'api/tab-summary'
...
export default {
  ...
  methods: {
    getList () {
      this.loading = true
      affectedApi(this.postObj).then(res => {
        this.loading = false
        if (res) {
          if (res.code === '0000') {
