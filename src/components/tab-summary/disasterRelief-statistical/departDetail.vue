<template>
  <div class="disasterRelief-statistical-detail nationalFlood-wrapper">
      ...
      <table border>
        <tbody>
          <tr>
            ...
            <td rowspan="4" style="width:80px;">上报部门</td>
    ...
    <div class="disasterRelief-statistical-page">
      <Page
        show-total
        show-elevator
        :total="total"
...
import { getDepartDetail } from 'api/disasterRelief-statistical'
...
<style lang="scss" scoped>
  .disasterRelief-statistical-detail {
    ...
    .disasterRelief-statistical-page {
      display: flex;
