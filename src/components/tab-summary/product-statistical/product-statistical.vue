  ...
  <div class="transfet-statical">
    ...
    <div class="title">
      ...
      <Breadcrumb separator=">">
        ...
        <BreadcrumbItem>气象产品查询</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <!-- <div class="search">
...
import { productThead } from 'common/js/table'
import { product, detailsApi } from 'api/tab-summary'
...
export default {
  ...
  methods: {
    ...
    details (obj) {
      ...
      this.spinShow = true
      detailsApi(obj.response_no).then(res => {
