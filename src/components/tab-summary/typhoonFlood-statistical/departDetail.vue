<template>
  <div class="typhoonFlood-statistical-detail nationalFlood-wrapper">
      ...
      <table border>
        <tbody>
          <tr>
            ...
            <td rowspan="3" style="width:50px">上报部门</td>
    ...
    <div class="typhoonFlood-statistical-page">
      <Page
        show-total
        show-elevator
        :total="total"
...
import { getDepartDetail } from 'api/typhoonFlood-statistical'
