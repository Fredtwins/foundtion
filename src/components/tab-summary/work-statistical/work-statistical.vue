  ...
  <div class="transfet-statical">
    ...
    <div class="title">
      ...
      <Breadcrumb separator=">">
        ...
        <BreadcrumbItem>工情查询与统计</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="search">
...
<script>
import { workThead } from 'common/js/table'
import { work } from 'api/tab-summary'
import { mapGetters, mapMutations } from 'vuex'
import { errorNotice } from 'common/js/dom'
import { workModule } from 'common/js/module'
...
export default {
  ...
  data () {
    return {
      addModuleData: workModule,
      addPageShow: false,
      tableThead: workThead(this),
      tableTbody: [],
      formItem: [],
      searchVal: {},
      total: 0,
