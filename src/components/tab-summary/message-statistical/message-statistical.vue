  ...
  <div class="transfet-statical">
    ...
    <div class="title">
      ...
      <Breadcrumb separator=">">
        ...
        <BreadcrumbItem>调度指令完成情况统计</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <!-- <div class="search">
...
import { messageThead } from 'common/js/table'
import { message } from 'api/tab-summary'
