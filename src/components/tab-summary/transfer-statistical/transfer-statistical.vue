  ...
  <div class="transfet-statical">
    ...
    <div class="title">
      ...
      <Breadcrumb separator=">">
        ...
        <BreadcrumbItem>转移人员统计</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <!-- <div class="search">
    ...
    <div v-if="addPageShow" class="addPage">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          <BreadcrumbItem>报表汇总</BreadcrumbItem>
          <BreadcrumbItem>事后报表统计</BreadcrumbItem>
          <BreadcrumbItem>人员转移统计</BreadcrumbItem>
...
import { transferThead } from 'common/js/table'
import { transferApi, detailsApi } from 'api/tab-summary'
...
export default {
  ...
  methods: {
    getList () {
      this.loading = true
      transferApi(this.postObj).then(res => {
        this.loading = false
        if (res) {
          if (res.code === '0000') {
    ...
    details (obj) {
      ...
      detailsApi({response_no: obj.response_no, department_level: '2'}).then(res => {
