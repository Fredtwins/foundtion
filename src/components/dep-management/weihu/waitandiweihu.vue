    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem>部门数据管理</BreadcrumbItem>
          <BreadcrumbItem to="/home/depManagement/waitandi">户外立式广告牌数据维护</BreadcrumbItem>
          <BreadcrumbItem>
...
<script>
import { getUserList, getaddlist, geteditlist } from 'api/waitandi'
