    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/jingdain">景点数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">景点数据</a>
          </BreadcrumbItem>
          ...
          <table class="ed-table">
            <tbody>
              ...
              <tr>
                ...
                <td class="ed-label">质量等级</td>
                <td class="ed-content">
                  <FormItem label prop="quality_level" style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.quality_level"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td class="ed-label">旅游企业(管理单位)</td>
                <td class="ed-content">
                  <FormItem label prop="company" style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.company"></Input>
                  </FormItem>
                </td>

                <td class="ed-label">复审人</td>
                <td class="ed-content">
              ...
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label prop="settlement_leader.name" style="margin: 0">
                    <Input
                      placeholder="请输入姓名"
                      style="width:80%"
                      v-model="formItem.settlement_leader.name"
                    ></Input>
                  </FormItem>
                </td>
                <!--&nbsp;&nbsp;-->
                ...
                <td class="ed-content">
                  <FormItem label prop="settlement_leader.telephone" style="margin: 0">
                    <Input
                      placeholder="请输入电话"
                      style="width:80%"
                      v-model="formItem.settlement_leader.telephone"
                    ></Input>
                  </FormItem>
                </td>
                <td class="ed-label">职务</td>
                <td class="ed-content">
                  <FormItem label prop="settlement_leader.duty" style="margin: 0">
                    <Input
                      placeholder="请输入职务"
                      style="width:80%"
                      v-model="formItem.settlement_leader.duty"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content" colspan="5">
                  <FormItem label prop="settlement_leader.settlement_address" style="margin: 0">
                    <Input
                      placeholder="请输入电话"
                      style="width:80%"
                      v-model="formItem.settlement_leader.settlement_address"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content" colspan="5">
                  <FormItem label prop="settlement_leader.settlement_name" style="margin: 0">
                    <Input
                      placeholder="请输入电话"
                      style="width:80%"
                      v-model="formItem.settlement_leader.settlement_name"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content" colspan="5">
                  <FormItem label prop="settlement_leader.company" style="margin: 0">
                    <Input
                      placeholder="请输入单位"
                      style="width:80%"
                      v-model="formItem.settlement_leader.company"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              ...
              <tr>
                <td class="ed-label">姓名</td>
                <td class="ed-content">
                  <FormItem label prop="transfer_leader.name" style="margin: 0">
                    <Input
                      placeholder="请输入姓名"
                      style="width:80%"
                      v-model="formItem.transfer_leader.name"
                    ></Input>
                  </FormItem>
                </td>
                <!--&nbsp;&nbsp;-->
                <td class="ed-label">电话</td>
                <td class="ed-content">
                  <FormItem label prop="transfer_leader.telephone" style="margin: 0">
                    <Input
                      placeholder="请输入电话"
                      style="width:80%"
                      v-model="formItem.transfer_leader.telephone"
                    ></Input>
                  </FormItem>
                </td>
                <td class="ed-label">职务</td>
                <td class="ed-content">
                  <FormItem label prop="transfer_leader.duty" style="margin: 0">
                    <Input
                      placeholder="请输入职务"
                      style="width:80%"
                      v-model="formItem.transfer_leader.duty"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td class="ed-label">单位</td>
                <td class="ed-content" colspan="5">
                  <FormItem label prop="transfer_leader.company" style="margin: 0">
                    <Input
                      placeholder="请输入单位"
                      style="width:80%"
                      v-model="formItem.transfer_leader.company"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              ...
              <tr>
                <td class="ed-label">主管部门</td>
                <td class="ed-content">
                  <FormItem label prop="warner.governor" style="margin: 0">
                    <Input
                      placeholder="请输入主管部门"
                      style="width:80%"
                      v-model="formItem.warner.governor"
                    ></Input>
                  </FormItem>
                </td>
                <!--&nbsp;&nbsp;-->
                <td class="ed-label">电话</td>
                <td class="ed-content">
                  <FormItem label prop="warner.telephone" style="margin: 0">
                    <Input
                      placeholder="请输入电话"
                      style="width:80%"
                      v-model="formItem.warner.telephone"
                    ></Input>
                  </FormItem>
                </td>
                <td class="ed-label">姓名</td>
                <td class="ed-content">
                  <FormItem label prop="warner.patroller" style="margin: 0">
                    <Input
                      placeholder="请输入姓名"
                      style="width:80%"
                      v-model="formItem.warner.patroller"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content" colspan="5">
                  <FormItem label prop="warner.charge_company" style="margin: 0">
                    <Input
                      placeholder="请输入管理单位"
                      style="width:80%"
                      v-model="formItem.warner.charge_company"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
...
<script>
import { getUserList, getaddlist, geteditlist } from 'api/jingdian'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/jingdian')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
