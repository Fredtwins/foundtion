    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/benzhan">泵站数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">泵站数据泵站数据</a>
          </BreadcrumbItem>
        ...
        <Form ref="formItem" :model="formItem" :label-width="0">
          <table class="ed-table">
            <tbody>
              ...
              <tr>
                <td class="ed-label">泵站编号</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.station_no"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">泵站类型</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.stion_type"></Input>
                  </FormItem>
                </td>
              </tr>

              <tr>
                <td class="ed-label">泵站名称</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.station_name"></Input>
                  </FormItem>
                </td>
              ...
              <tr>
                <td class="ed-label">总装机容量 (千瓦)</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.installed_capacity"
                    ></Input>
                  </FormItem>
                </td>
                <td class="ed-label">机组台数</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.pump_count"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">水泵口径（单台）</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.pump_caliber"></Input>
                  </FormItem>
                </td>
              </tr>

              <tr>
                <td class="ed-label">功能</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.pump_function"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">总开机流量</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.total_flow"></Input>
                  </FormItem>
                </td>
              ...
              <tr>
                <td class="ed-label">排水-受益面积(亩)</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                ...
                <td class="ed-label">灌溉-受益面积(亩)</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.irrigation_area"></Input>
                  </FormItem>
                </td>
              </tr>

              <tr>
                <td class="ed-label">历史最高水位</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.his_level"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">历史最高水位时间</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.his_level_date"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">突变水位</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.abrupt_level"></Input>
                  </FormItem>
                </td>
              </tr>
              ...
              <tr>
                <td class="ed-label">内江防洪水位</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.inner_river_flooor"
                    ></Input>
                  </FormItem>
                </td>
                <td class="ed-label">外江防洪水位</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.outer_river_flooor"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入电话" style="width:80%" v-model="formItem.operator.duty"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
...
<script>
import { getUserList, getaddlist, geteditlist } from 'api/benzhan'
...
export default {
  ...
  data () {
    return {
      // iconFeatures: [],
      // iconFeature:new ol.Feature(new ol.geom.Point([113.107406294, 23.257379032])),
      iconFeature: [],
      amapManager,
      zoom: 12,
      center: [],
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/benzhan')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
