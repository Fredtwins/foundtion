    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/shuiku">水库数据维护</BreadcrumbItem>
          <BreadcrumbItem>
                ...
                <td class="ed-content">
                  <FormItem label prop="maindike_topheight" style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.maindike_topheight"
                    ></Input>
                  </FormItem>
                </td>
              ...
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label prop="rainwater_area" style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.rainwater_area"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label prop="project_target" style="margin: 0">
                    <Select
                      placeholder="请选择"
                      style="width:80%"
                      v-model="formItem.project_target"
                ...
                <td class="ed-content" colspan="3">
                  <FormItem label prop="protection_object" style="margin: 0">
                    <Select
                      placeholder="请选择"
                      style="width:80%"
                      v-model="formItem.protection_object"
                      :disabled="formDisabled"
                      @on-change="planTypeSelect"
                      filterable
                    >
...
<script>
import { shequThead } from 'common/js/table'
