	...
	<div class="tiweiweihu">
        ...
        <span class="titleleft"></span>
				...
				<Breadcrumb separator=">">
					...
					<BreadcrumbItem to="/home/depManagement/zilaishui">自来水厂信息数据维护</BreadcrumbItem>
					<BreadcrumbItem>
						<a href="javascript:;" @click='cancel'>自来水厂信息数据</a>
					</BreadcrumbItem>
					<!--<BreadcrumbItem>{{moduleTitle}}</BreadcrumbItem>-->
				</Breadcrumb>
			</div>
			<div class="editHead">
				<span>自来水厂信息数据信息</span>
				 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				<div class="ddto">
			...
			<div class="editcontant">
              ...
              <h2 class="titlename">基本情况</h2>
							...
							<tr>
								<td class="ed-label">水厂编号</td>
								<td class="ed-content">
									<FormItem label="" style="margin: 0">
										<Input placeholder="请输入" style="width:80%" v-model="formItem.factory_no"></Input>
									</FormItem>
								</td>

								<td class="ed-label">投产时间</td>
								<td class="ed-content">
									<FormItem label="" style="margin: 0">
										<Input placeholder="请输入" style="width:80%" v-model="formItem.product_datetime"></Input>
									</FormItem>
								</td>
							...
							<tr>
								<td class="ed-label">供水水源</td>
								<td class="ed-content">
									<FormItem label="" style="margin: 0">
										<Input placeholder="请输入" style="width:80%" v-model="formItem.water_sourcr"></Input>
									</FormItem>
								</td>

								<td class="ed-label">消毒方式</td>
								<td class="ed-content">
									<FormItem label="" style="margin: 0">
										<Input placeholder="请输入" style="width:80%" v-model="formItem.disinfect"></Input>
									</FormItem>
								</td>
								<td class="ed-label">净水工艺</td>
								<td class="ed-content">
									<FormItem label="" style="margin: 0">
										<Input placeholder="请输入" style="width:80%" v-model="formItem.technology"></Input>
									</FormItem>
								</td>
							</tr>
...
<script>
import { getshuichangList } from 'api/shujuage'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/zilaishui')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
      ...
      if (getLocalStorage('id') !== 'false') {
        getshuichangList(search).then(res => {
          if (res.code === ERR_OK) {
