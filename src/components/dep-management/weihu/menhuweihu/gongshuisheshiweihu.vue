    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/gongshuisheshi">供水设施数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">供水设施数据</a>
          </BreadcrumbItem>
          ...
          <table class="ed-table">
            <tbody>
              ...
              <tr>
                ...
                <td class="ed-content" colspan="5">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.diameter"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.pipe_line_name"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">编号</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.pipe_line_no"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">类型</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.pipe_line_type"></Input>
                  </FormItem>
                </td>
              </tr>
            </tbody>
...
<script>
import { getpaisheshiList } from 'api/shujuage'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/gongshuisheshi')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
      ...
      if (getLocalStorage('id') !== 'false') {
        getpaisheshiList(search).then(res => {
          if (res.code === ERR_OK) {
