	...
	<div class="tiweiweihu">
        ...
        <span class="titleleft"></span>
				...
				<Breadcrumb separator=">">
					...
					<BreadcrumbItem to="/home/depManagement/wushuichang">污水厂信息数据维护</BreadcrumbItem>
					<BreadcrumbItem>
						<a href="javascript:;" @click='cancel'>污水厂信息数据</a>
					</BreadcrumbItem>
...
<script>
import { getwushuichangList } from 'api/shujuage'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/wushuichang')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
      ...
      if (getLocalStorage('id') !== 'false') {
        getwushuichangList(search).then(res => {
          if (res.code === ERR_OK) {
