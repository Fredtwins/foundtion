    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/yiyuan">医院信息数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">医院信息数据</a>
          </BreadcrumbItem>
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/yiyuan')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
