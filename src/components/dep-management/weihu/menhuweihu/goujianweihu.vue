    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/goujian">构建数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">构建数据</a>
          </BreadcrumbItem>
        ...
        <Form ref="formItem" :model="formItem" :label-width="0">
          <table class="ed-table">
            <tbody>
              ...
              <tr>
                <td class="ed-label">所在地</td>
                <td class="ed-content" colspan="5">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.wheretown"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td class="ed-label">所属河道</td>
                <td class="ed-content" colspan="5">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.whereriver"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.pilenum"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td class="ed-label">建筑物名称</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.building"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">占用面积</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.measure"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">层数</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.floor"></Input>
                  </FormItem>
                </td>
              </tr>

              <tr>
                <td class="ed-label">位于哪里</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.atarea"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">建设年份</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.builtyear"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">是否历史建筑物</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.ishistory"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td class="ed-label">是否办理水利手续</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.hascert"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">创建人</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.createman"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">创建时间</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.creatime"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.nots"></Input>
                  </FormItem>
                </td>
              </tr>
            </tbody>
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/goujian')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
