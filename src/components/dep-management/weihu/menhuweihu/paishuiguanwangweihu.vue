    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/paishuiguanwang">排水管网数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">排水管网数据</a>
          </BreadcrumbItem>
...
<script>
import { getpaishuiList } from 'api/shujuage'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/paishuiguanwang')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
      ...
      if (getLocalStorage('id') !== 'false') {
        getpaishuiList(search).then(res => {
          if (res.code === ERR_OK) {
