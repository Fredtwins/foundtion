    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/paishuisheshi">排水设施数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">排水设施数据</a>
          </BreadcrumbItem>
...
<script>
import { getsheshiList } from 'api/shujuage'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/paishuisheshi')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
