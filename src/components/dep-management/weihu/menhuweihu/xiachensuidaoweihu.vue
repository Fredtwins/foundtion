    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/xiachensuidao">下沉隧道数据维护</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">下沉隧道数据</a>
          </BreadcrumbItem>
          ...
          <table class="ed-table">
            <tbody>
              ...
              <tr>
                ...
                <td class="ed-content" colspan="5">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.所在位置"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防洪预案是否编制"></Input>
                  </FormItem>
                </td>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.群众转移方案是否编制"></Input>
                  </FormItem>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛行政责任人['姓名']"></Input>
                  </FormItem>
                </td>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛行政责任人['单位']"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛行政责任人['职务']"></Input>
                  </FormItem>
                </td>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛行政责任人['电话']"></Input>
                  </FormItem>
                </td>
              ...
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛技术责任人['姓名']"></Input>
                  </FormItem>
                </td>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛技术责任人['单位']"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛技术责任人['职务']"></Input>
                  </FormItem>
                </td>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.防汛技术责任人['电话']"></Input>
                  </FormItem>
                </td>
              </tr>
              <!-- <tr>
                ...
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.防汛抢险物资储备现状情况['袋类（条）']"
                    ></Input>
                  </FormItem>
                </td>

                <td class="ed-label">流动抽水泵(台)</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.防汛抢险物资储备现状情况['流动抽水泵(台)']"
                    ></Input>
                  </FormItem>
                </td>
                <td class="ed-label">流动抽水泵(台)</td>
              ...
              <tr>
                <td class="ed-label">探照灯(支)</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.防汛抢险物资储备现状情况['探照灯(支)']"
                    ></Input>
                  </FormItem>
                </td>

                <td class="ed-label">应急供电设备(台)</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input
                      placeholder="请输入"
                      style="width:80%"
                      v-model="formItem.防汛抢险物资储备现状情况['应急供电设备(台)']"
                    ></Input>
                  </FormItem>
                </td>
              </tr>
...
<script>
import { getshangchangList } from 'api/shujuage'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/xiachensuidao')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
      ...
      if (getLocalStorage('id') !== 'false') {
        getshangchangList(search).then(res => {
          if (res.code === ERR_OK) {
