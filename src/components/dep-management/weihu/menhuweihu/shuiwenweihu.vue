    ...
    <div class="edit">
      <div class="title">
        ...
        <Breadcrumb separator=">">
          ...
          <BreadcrumbItem to="/home/depManagement/shuiwen">水文信息数据</BreadcrumbItem>
          <BreadcrumbItem>
            <a href="javascript:;" @click="cancel">水文信息数据</a>
          </BreadcrumbItem>
        ...
        <Form ref="formItem" :model="formItem" :label-width="0">
          <table class="ed-table">
            <tbody>
              ...
              <tr>
                <td class="ed-label">数据来源</td>
                <td class="ed-content" colspan="5">
                  <FormItem label prop="admauth" style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.admauth"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td class="ed-label">警戒水位1</td>
                <td class="ed-content" colspan="5">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.alarm_l1"></Input>
                  </FormItem>
                </td>
              </tr>
              <tr>
                <td class="ed-label">警戒水位2</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.alarm_l2"></Input>
                  </FormItem>
                </td>

                <td class="ed-label">警戒水位3</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.alarm_l3"></Input>
                  </FormItem>
                </td>
              </tr>

              <tr>
                <td class="ed-label">流域</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.basin"></Input>
                  </FormItem>
                </td>
              ...
              <tr>
                ...
                <td class="ed-label">水系</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
                    <Input placeholder="请输入" style="width:80%" v-model="formItem.hydr_net"></Input>
                  </FormItem>
                </td>
                <td class="ed-label">所属河流</td>
                <td class="ed-content">
                  <FormItem label style="margin: 0">
...
<script>
import { getshuiwenList } from 'api/shujuage'
...
export default {
  ...
  methods: {
    ...
    cancel () {
      this.$router.push('/home/depManagement/shuiwen')
    },
    // 表格显示
    _getuserlist (search) {
      search = {
      ...
      if (getLocalStorage('id') !== 'false') {
        getshuiwenList(search).then(res => {
          if (res.code === ERR_OK) {
