  ...
  <div class="tiwei">
    <div class="title">
      ...
      <Breadcrumb separator=">">
        <BreadcrumbItem to="/home/depManagement/changsuo">部门管理</BreadcrumbItem>
        <BreadcrumbItem>部门数据维护</BreadcrumbItem>
        <BreadcrumbItem>避难场所数据维护</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <!--搜索-->
...
<script>
import { changsuoThead } from 'common/js/table'
import { getUserList, getdellist, getuserList } from 'api/changsuo'
...
export default {
  ...
  methods: {
    ...
    add () {
      ...
      this.$router.push('/home/depManagement/changsuo/changsuoweihu')
    },
    edit (dataObj) {
