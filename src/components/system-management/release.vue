          ...
          <table class="ed-table disabled-color">
            <tbody>
              ...
              <tr style="height:80px">
                <td class="ed-label">
                  <span class="font-color">*</span>通知公告内容
                </td>
                ...
                <td class="ed-content upload" colspan="5">
                  <div>
                    <Upload
                      ...
                      action="http://192.168.1.138:8080/sanfangstruts/oa/sf_notice/upload?systemId=1000010"
                    >
                    ...
                    <input
                      style="marginLeft:5px;lineHeight:33px;border:none"
                      v-if="filename"
                      v-model="filename"
                    >
                    <input
                      style="marginLeft:5px;lineHeight:33px;border:none"
                      v-else="filename"
                      v-model="formItem.attachment_name"
                    >
...
import { noticeApi, uploadApi, url } from 'api/daily-office'
