...
export function getuserList (page = 1, search = {}) {
  let url = 'dp/geological_disaster_info/list'
...
export function getaddlist (obj) {
  let url = 'dp/geological_disaster_info/new'
...
export function geteditlist (obj) {
  let url = 'dp/geological_disaster_info/edit'
...
export function getdellist (ids) {
  let url = 'dp/geological_disaster_info/delete'
